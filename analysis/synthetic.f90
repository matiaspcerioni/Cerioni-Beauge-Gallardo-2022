  ...
  real*8 mean(0:2,2,2,0:20),sig(0:2,2,2,0:20),diff(0:2,2,2,0:20)
  character(len=50) arch_in,arch_out,arch_stat
  ...
  mjup  = 9.54792d-4
  !
  open (3,file='sinteticos.dat',status='replace')
  open (4,file='stat_sinteticos.dat',status='replace')
...
!!! lee datos correspondientes a tripletes reales.
  arch_in = 'tripletes_compactos_baja_masa.dat'
  !  arch_in = '3p-mmr_julio2021.dat'
